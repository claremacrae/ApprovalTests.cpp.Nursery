...
TEST_CASE("YouCanVerifyCombinationsOf1MoreVaried") {
...
TEST_CASE("YouCanVerifyCombinationsOf2MoreVaried") {
    // A case with simpler data, to check that all the 
    // arguments are passed through in the correct order.
    CombinationApprovalsNew::verifyAllCombinations<
            std::vector<std::string>,
...
TEST_CASE("YouCanVerifyCombinationsOf3MoreVaried") {
    // A case with simpler data, to check that all the 
    // arguments are passed through in the correct order.
    CombinationApprovalsNew::verifyAllCombinations<
            std::vector<std::string>,
...
TEST_CASE("YouCanVerifyCombinationsOf4MoreVaried") {
    // A case with simpler data, to check that all the 
    // arguments are passed through in the correct order.
    CombinationApprovalsNew::verifyAllCombinations<
            std::vector<std::string>,
...
TEST_CASE("YouCanVerifyCombinationsOf5MoreVaried") {
    // A case with simpler data, to check that all the 
    // arguments are passed through in the correct order.
    CombinationApprovalsNew::verifyAllCombinations<
            std::vector<std::string>,
...
TEST_CASE("YouCanVerifyCombinationsOf6MoreVaried") {
    // A case with simpler data, to check that all the 
    // arguments are passed through in the correct order.
    CombinationApprovalsNew::verifyAllCombinations<
            std::vector<std::string>,
...
TEST_CASE("YouCanVerifyCombinationsOf7MoreVaried") {
    // A case with simpler data, to check that all the 
    // arguments are passed through in the correct order.
    CombinationApprovalsNew::verifyAllCombinations<
            std::vector<std::string>,
...
TEST_CASE("YouCanVerifyCombinationsOf8MoreVaried") {
    // A case with simpler data, to check that all the 
    // arguments are passed through in the correct order.
    CombinationApprovalsNew::verifyAllCombinations<
            std::vector<std::string>,
...
TEST_CASE("YouCanVerifyCombinationsOf9MoreVaried") {
    // A case with simpler data, to check that all the 
    // arguments are passed through in the correct order.
    CombinationApprovalsNew::verifyAllCombinations<
            std::vector<std::string>,
